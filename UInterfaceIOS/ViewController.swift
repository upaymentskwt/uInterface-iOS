...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.customerUniqueNumber = "1234567890845"
...
//        apiToken = "6407c050db6642c64a204eb8e1591c3c07a8ac49" // For White Label (Production)
        ...
        lblDropDownTitle.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(showDropDown)))
    }
    ...
    @IBAction func onClickCloseDropDownView(_ sender: Any) {
        dropDownContainerView.isHidden = true
    }
...
//            self.apiToken = "6407c050db6642c64a204eb8e1591c3c07a8ac49"
    ...
    func initiateSingleProductPayment() {
        ...
        let paymentGatewayDetail = PaymentGatewayModel(src: sourceValue)
...
//            )
            ...
            lblDropDownTitle.text = paymentValue
        }
        dropdown.show()
    }
